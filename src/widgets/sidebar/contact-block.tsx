...
import codeWarsIcon from '@/shared/assets/icons/codewars.svg';
        ...
        <div className={style.contactsBlock}>
            ...
            <Tooltip title="Linkedin" placement="top" arrow={true}>
                <div className={style.contactsBlockItem}>
                    ...
                    <a
                        href="https://www.linkedin.com/in/dmitry-lotkov-25306a1ba/"
                        target="_blank"
